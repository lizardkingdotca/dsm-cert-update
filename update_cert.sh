...
CERT_FILE_NAME_SRC="${CERT_FILE_NAME_SRC:-cert.pem}"
readonly CERT_FILE_NAME_SRC

CHAIN_FILE_NAME_SRC="${CHAIN_FILE_NAME_SRC:-chain.pem}"
readonly CHAIN_FILE_NAME_SRC

FULLCHAIN_FILE_NAME_SRC="${FULLCHAIN_FILE_NAME_SRC:-fullchain.pem}"
readonly FULLCHAIN_FILE_NAME_SRC

KEY_FILE_NAME_SRC="${KEY_FILE_NAME_SRC:-privkey.pem}"
